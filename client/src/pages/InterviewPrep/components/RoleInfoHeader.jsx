  ...
  return (
    <div className='bg-white relative'>
        <div className="container mx-auto px-10 md:px-0">
                    ...
                    <div className="flex-grow">
                        <div className="flex justify-between items-start">
                            <div>
                                ...
                                <p className="text-sm font-medium text-gray-900 mt1">{topicsToFocus}</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className="w-[40vw] md:w-[30vw] h-[200px] flex items-center justify-center overflow-hidden absolute bg-white top-0 right-0">
